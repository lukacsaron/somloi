...
function be_display_posts_shortcode( $atts ) {
	...
	while ( $listing->have_posts() ): $listing->the_post(); global $post;
		...
		$output = '<' . $inner_wrapper . ' class="' . implode( ' ', $class ) . '">' . "<div class=image-wrapper>" . $image . "</div>" . "<div class=content-wrapper>" . $title . $date . $author . $category_display_text . $excerpt . $content . "</div>" . '</' . $inner_wrapper . '>';
		/**
